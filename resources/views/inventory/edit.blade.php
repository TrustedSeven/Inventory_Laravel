...
<div class="w-4/5 m-auto pt-20">
    <form action="/inventory/{{ $inventory->slug }}" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="text-white mb-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Inventory</button>
