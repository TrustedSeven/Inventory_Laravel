...
@section('content')
<div class="h-full bg-cover" style="background-image: url(https://articles.cyzerg.com/hubfs/Warehouse%20Inventory%20Management.jpg); height:93.1vh;">
    <main class="sm:container sm:mx-auto sm:max-w-lg">
        <div class="flex">
            <div class="w-full">
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg  mt-10 ml-5 mr-5">
